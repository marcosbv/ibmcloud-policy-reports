...
for i in gatherData.sh policiesForResource.js resourceAccessForUser.js utils.js policiesForRole.js latestUserLogin.js saveAndUploadCSVReports.sh policiesForService.js policiesByUserAndAccessGroup.js
do
